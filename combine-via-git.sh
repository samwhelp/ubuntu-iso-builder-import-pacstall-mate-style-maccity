...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-mate-style-maccity"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-mate-style-maccity/iso-profile
"
echo
