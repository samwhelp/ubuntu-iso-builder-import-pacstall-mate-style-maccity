...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-style-maccity/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-style-maccity/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-style-maccity/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-mate-style-maccity](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-style-maccity)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-style-maccity.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-mate-style-maccity`

``` sh
cd ubuntu-iso-builder-import-pacstall-mate-style-maccity
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-mate-style-maccity/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-mate-style-maccity/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-mate-style-maccity/iso-profile/dist`
